...
def load_wav(wav_path, mono=False):
    return librosa.load(wav_path, sr=None, mono=mono)
...
def process(item):
    ...
    if os.path.exists(wav_path) and '.wav' in wav_path:
        ...
        wav, sr = load_wav(wav_path, mono=args.mono)
        wav, _ = trim_wav(wav)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mono", action="store_true", help="Convert to mono while resampling")
